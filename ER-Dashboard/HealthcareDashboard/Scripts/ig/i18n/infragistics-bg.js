...
if (!$.ig.Grid) {
    ...
    $.extend($.ig.GridLoadOnDemand, {
        locale: {
            pullToRefresh: 'Придърпай за обновяване',
            releaseToRefresh: 'Освободи за обновяване',
            pullToLoadData: 'Придърпай за зареждане на данни',
            releaseToLoadData: 'Освободи за зареждане на данни',
...
if (!$.ig.TileManager) {
	...
	$.extend($.ig.TileManager, {
		locale: {
		    ...
		    tileToMaximizeNotProvidedError: "Не е подадена плочката, която трябва да се максимизира.",
		    tileAlreadyMaximizedError: "Плочката е вече максимизирана."
		}
	});
