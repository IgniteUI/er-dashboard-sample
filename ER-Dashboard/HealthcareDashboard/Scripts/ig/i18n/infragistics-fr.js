...
if (!$.ig.Grid) {
	...
	$.extend($.ig.GridSorting, {
		locale: {
			...
			featureChooserSortAsc: 'Trier par ordre croissant',
			featureChooserSortDesc: 'Trier par ordre décroissant'
    ...
    $.extend($.ig.GridLoadOnDemand, {
    	locale: {
    	    pullToRefresh: "Glisser pour actualiser",
    	    releaseToRefresh: "Relâcher pour actualiser",
    	    pullToLoadData: "Glisser pour charger les données",
    	    releaseToLoadData: "Relâcher pour charger les données",
...
if (!$.ig.TileManager) {
	...
	$.extend($.ig.TileManager, {
		locale: {
		    ...
		    tileToMaximizeNotProvidedError: "La mosaïque à agrandir n'a pas été fournie.",
		    tileAlreadyMaximizedError: "La mosaïque est déjà agrandie."
		}
	});
