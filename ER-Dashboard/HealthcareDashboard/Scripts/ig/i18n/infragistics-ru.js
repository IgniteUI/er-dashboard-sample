...
if (!$.ig.Grid) {
	...
	$.extend($.ig.GridSorting, {
		locale: {
			...
			featureChooserSortAsc: 'Сортировать А-Я',
			featureChooserSortDesc: 'Сортировать Я-А'
    ...
    $.extend($.ig.ColumnMoving, {
        locale: {
            ...
            featureChooserSubmenuText: 'Переместить'
        }
    });
    ...
    $.extend($.ig.GridLoadOnDemand, {
    	locale: {
    	    ...
    	    pullToLoadData: 'Потяните для загрузки',
    	    releaseToLoadData: 'Отпустите для загрузки новых данных',
...
if (!$.ig.TileManager) {
	...
	$.extend($.ig.TileManager, {
		locale: {
			...
			tileToMaximizeNotProvidedError: "Максимизированная плитка не задана.",
			tileAlreadyMaximizedError: "Плитка уже максимизирована."
		}
	});
