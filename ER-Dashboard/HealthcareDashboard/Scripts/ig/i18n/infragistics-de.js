...
if (!$.ig.Grid) {
    ...
    $.extend($.ig.GridLoadOnDemand, {
        locale: {
            pullToRefresh: 'Zum Aktualisieren nach unten streichen',
            releaseToRefresh: 'Zum Aktualisieren loslassen',
            pullToLoadData: 'Zum Laden von Daten nach unten streichen',
            releaseToLoadData: 'Zum Laden von Daten loslassen',
...
if (!$.ig.TileManager) {
	...
	$.extend($.ig.TileManager, {
		locale: {
		    ...
		    tileToMaximizeNotProvidedError: "Die zu maximierende Kachel wurde nicht angegeben.",
		    tileAlreadyMaximizedError: "Die Kachel ist bereits maximiert."
		}
	});
...
/*!@license
* Infragistics.Web.ClientUI utilities localization resources 13.2.20132.334
*
* Copyright (c) 2011-2013 Infragistics Inc.
*
* http://www.infragistics.com/
